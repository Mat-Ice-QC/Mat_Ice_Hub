...
description: "A PowerShell script that disables microphones via registry keys using regex matching — because sometimes you just don’t want that mic alive."
...
> _“I needed a way to disable my camera microphone with PowerShell...  
> Took me like 4 hours and some gatorwine🍷.  
> So yeah — don’t look at it too hard.”_  
> — **Mat Ice**, 2025
...
It’s more reliable than trying to disable them via PnP or Device Manager when you’re working in locked-down or managed environments.
...
2. **Enumerate Audio Devices**
   ...
   ```
   Finds all capture devices with “Microphone” in their name.
...
4. **Handles Errors Gracefully**
   ...
   - Tells you if you’re not running as Administrator  
...
- A bit of patience (and optionally, **gatorwine**) 🍷
...
Full text available at [https://www.gnu.org/licenses/agpl-3.0.html](https://www.gnu.org/licenses/agpl-3.0.html)

---

### TL;DR

Disables your mic from the registry because Windows said “no” too many times.  
