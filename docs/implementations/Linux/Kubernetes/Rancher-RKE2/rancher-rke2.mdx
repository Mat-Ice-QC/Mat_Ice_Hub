...
* **Ports:**
  ...
  * 9345/tcp — RKE2 internal communication
  * 80/443/tcp — Rancher web interface
...
## 4. Install kubectl and Helm (if missing)
...
## 7. Install Rancher GUI

Create the namespace and deploy Rancher GUI via Helm:
